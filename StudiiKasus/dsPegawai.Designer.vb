...
Partial Public Class dsPegawai
    ...
    Partial Public Class PEGAWAIDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Overloads Function AddPEGAWAIRow(ByVal NIP As String, ByVal nama_Pegawai As String, ByVal Tanggal_Lahir As Date, ByVal Jenis_Kelamin As String, ByVal Alamat As String, ByVal Telepon As String) As PEGAWAIRow
    ...
    Partial Public Class PEGAWAIRow
        ...
        Public Property Tanggal_Lahir() As Date
            Get
                Return CType(Me(Me.tablePEGAWAI.Tanggal_LahirColumn),Date)
            End Get
            Set
        ...
        Public Property Telepon() As String
            Get
                Return CType(Me(Me.tablePEGAWAI.TeleponColumn),String)
            End Get
            Set
                Me(Me.tablePEGAWAI.TeleponColumn) = value
            End Set
        End Property
    End Class
